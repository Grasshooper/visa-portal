        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div className="bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-950 dark:to-purple-950 rounded-lg p-8 aspect-square flex items-center justify-center">
              <div className="text-4xl font-bold text-center text-primary">ImmigrationPro</div>
            </div>
            <div className="space-y-4">
              <h2 className="text-2xl font-bold">Our Mission</h2>
              <p className="text-muted-foreground">
                At ImmigrationPro, we believe in making the immigration process more accessible, 
                transparent, and efficient for everyone. Our platform connects immigrants with 
                legal representatives and provides tools to streamline case management.
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="bg-card p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-sm text-center text-muted-foreground">Founder & CEO</p>
                <p className="mt-2 text-sm text-center">Immigration attorney with over 15 years of experience.</p>
              </div>
              <div className="bg-card p-6 rounded-lg shadow-sm border">
                <div className="w-20 h-20 rounded-full bg-muted mx-auto mb-4"></div>
                <h3 className="font-bold text-lg text-center">John Smith</h3>
                <p className="text-sm text-center text-muted-foreground">Technical Director</p>
                <p className="mt-2 text-sm text-center">Expert in legal tech solutions and automation.</p>
              </div>
              <div className="bg-card p-6 rounded-lg shadow-sm border">
                <div className="w-20 h-20 rounded-full bg-muted mx-auto mb-4"></div>
                <h3 className="font-bold text-lg text-center">Maria Garcia</h3>
                <p className="text-sm text-center text-muted-foreground">Client Support Lead</p>
                <p className="mt-2 text-sm text-center">Dedicated to ensuring client success through every step.</p>
              </div>
            </div>
          </div>
